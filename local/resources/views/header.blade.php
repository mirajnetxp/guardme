...
<header id="header" class="clearfix">
    ...
    @if($isVerified = (Auth::check() && ! Auth::user()->verified && ! session('need_email_confirmation')))
        <div class="alert alert-danger" role="alert"
             style="position: fixed;top: 0px;left: 0px;width: 100%;z-index:9999;border-radius:0px;padding:5px;">
            <div class="container">
                <div class="pull-left" style="margin-top: 8px">
                    A confirmation email was sent to
                    <strong>{{ $changedEmail = $new_email ?: Auth::user()->email }}</strong>.
                ...
                <div class="pull-right"><a href="{!! route('user.resend_verification') !!}" class="btn btn-default">Resend
                        confirmation</a></div>
            </div>
        </div>
    @endif
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo $url;?>">
                    ...
                    <img src="<?php echo $url . '/local/images/settings/' . $setts[0]->site_logo;?>"
                         class="img-responsive" alt="<?php echo $setts[0]->site_name;?>"/>
					<?php } else { ?>
            ...
            <div class="navbar-left">
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    ...
                    <!-- Added by Ninja 20180331 start here-->
                        <li class="@if(Route::current()->uri()=='/') {{ 'active' }} @endif"><a
                                    href="<?php echo $url;?>/">Home</a></li>
                        <li><a href="http://blog.guarddme.com">Blog</a></li>
                        <li class="@if(Route::current()->uri()=='search') {{ 'active' }} @endif"><a
                                    href="<?php echo $url;?>/search">Hire Security</a></li>
                ...
                <ul class="sign-in">
                    ...
                    <li>
                        <div class="btn-group">
                            ...
                            <i class="fa fa-bell-o" style="
                                ...
                                padding-right: 10px;
                                ">
                                <span class="badge hidden" style="position: absolute;top: -10px;left: 10px;"></span>
                            </i>
					        </span>
                    ...
                    <li class="dropdown li-last">
                        <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">
                            Hi, {{ Auth::user()->name }}<b class="caret"></b></a>
