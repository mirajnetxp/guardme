...
@section('content')
    ...
    <form id="create_job_schedule" method="POST" action="{{ route('api.schedule.job', ['id' => $id]) }}">
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" value="{{$job->number_of_freelancers}}" placeholder="Number of freelacers you want to hire for this job" class="number_of_freelancers form-control" name="number_of_freelancers">
