...
@section('content')
    ...
    <div class="banner-form banner-form-full job-list-form">
        <form method="get" action="{{ url('/wallet/jobs/find') }}" id="formID">
            <input type="text" class="form-control" style="width: 100%;" placeholder="Job search" name="keyword"
                   value="{{old('keyword')}}">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="start_date date-picker form-control" name="start_date"
                                               placeholder="Start Date" required="true" value="{{old('start_date')}}">
            ...
            <div class="col-md-4">
                ...
                <div class="section quick-rules job-postdetails">
                    ...
                    <ul>
                        ...
                        <li>
                            Please update your bank or Paypal details in the settings page to ensure that you get paid
                            all credit balances.
                        </li>
                        <li>
                            Freelancers receive a job fee only. There is no charge on this fee and it is a freelancers'
                            responsibility to file their taxes.
                        </li>
                        <li>
                            All transactions that are paid into the GuardME marketplace is subject to VAT and an admin
                            fee. This is usually paid during the creation of a job.
                        </li>
                        <li>
